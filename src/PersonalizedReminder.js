    ...
    const reminders = [
      {
        ...
        gif: 'https://media0.giphy.com/media/S8DcNuvt1FUy31LUH6/giphy.gif'
      },
      {
      ...
      {
        text: ' розімни плечі.',
        gif: 'https://media0.giphy.com/media/FQaQtdbLnk676/giphy.gif'
      },
      {
        text: ' зроби ковток води.',
        gif: 'https://media2.giphy.com/media/93r05rdKx5vDw5hWn5/giphy.gif'
      },
      {
      ...
      {
        text: ' перевір поставу!',
        gif: 'https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExaWU2azZ4dGd1ejYybHN0eHAybnV1MmtrZm5odWxvY3c2YmVkNzVwZiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/l3vRaWAPakjiEUQow/giphy.gif'
      },
      {
        text: ' зроби глибокий вдих і повільний видих.',
        gif: 'https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExbmNvdmI1NXlleTBncmIzdzFjMDBmcHZwbG0wOXc4OXh3czF3eWpnYyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/RT3S8fkHUxECJJpwvT/giphy.gif'
      },
      {
        text: ' зроби легку зарядку або пройдися по кімнаті',
        gif: 'https://i.giphy.com/4KkSbPnZ5Skec.webp'
      }
    ];
